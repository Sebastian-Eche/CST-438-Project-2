...
export default function Profile() {
   ...
   const handleDeleteAccount = () => {
       const token = localStorage.getItem("token");
       const confirmedPassword = prompt("Please enter your password to delete your account:");

       if (!confirmedPassword) return;

       fetch(`/auth/deleteAcc?id=${userData.id}&password=${encodeURIComponent(confirmedPassword)}`, {
           method: "DELETE",
           headers: {
               "Authorization": `Bearer ${token}`
           }
               ...
               <div style={styles.card}>
                   {!editMode ? (
                       ...
                       <div>
                           ...
                           {updateMessage && (
                               <div style={updateMessage.includes("Error") ? styles.errorMessage : styles.successMessage}>
                                   {updateMessage}
                               </div>
                           )}
                       </div>
